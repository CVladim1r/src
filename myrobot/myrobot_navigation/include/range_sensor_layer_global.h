#ifndef RANGE_SENSOR_LAYER_RANGE_SENSOR_LAYER_GLOBAL_H_
#define RANGE_SENSOR_LAYER_RANGE_SENSOR_LAYER_GLOBAL_H_

#include <ros/ros.h>
#include <costmap_2d/costmap_layer.h>
#include <costmap_2d/layered_costmap.h>
#include <sensor_msgs/Range.h>
#include <myrobot_navigation/RangeSensorLayerGlobalConfig.h>
...
class RangeSensorLayerGlobal : public costmap_2d::CostmapLayer
{
public:
...
private:
  void reconfigureCB(range_sensor_layer_global::RangeSensorLayerGlobalConfig &config, uint32_t level);
  ...
  dynamic_reconfigure::Server<range_sensor_layer_global::RangeSensorLayerGlobalConfig> *dsrv_;
...
#endif  // RANGE_SENSOR_LAYER_RANGE_SENSOR_LAYER_GLOBAL_H
